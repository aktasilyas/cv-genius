...
const Signup = () => {
  ...
  const features = [
    ...
    t('auth.feature2') || 'Professional templates',
    t('auth.feature3') || 'Export to PDF',
    t('auth.feature4') || 'ATS optimization',
  ];
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            ...
            <h1 className="text-4xl xl:text-5xl font-bold text-primary-foreground mb-6 leading-tight">
              {t('auth.signupTitle') || 'Start building your dream CV today'}
            </h1>
            
            <p className="text-lg text-primary-foreground/70 mb-10 max-w-md">
              {t('auth.signupSubtitle') || 'Join thousands of professionals who landed their dream jobs with our AI-powered CV builder.'}
            </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col min-h-screen lg:min-h-0">
        ...
        <div className="lg:hidden bg-primary px-4 py-6 safe-area-inset-top">
          ...
          <p className="mt-1 text-primary-foreground/70 text-sm">
            {t('auth.signupSubtitle') || 'Start building your dream CV'}
          </p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-12">
          ...
          >
            ...
            <p className="mt-6 sm:mt-8 text-center text-xs sm:text-sm text-muted-foreground">
              {t('auth.termsText') || 'By signing up, you agree to our'}{' '}
